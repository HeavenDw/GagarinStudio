...
Например:
data-spoilers="991.98,max" - споллеры будут работать только на экранах меньше или равно 992px
data-spoilers="767.98,min" - споллеры будут работать только на экранах больше или равно 768px

родителю спойлеров выдаётся класс _init
кнопке выдается _active при активации
